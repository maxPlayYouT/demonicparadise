	...
	*/
	...
	$config_lk = array(
		...
		'db' =>	array (
			...
			'host'	=> 'localhost',
			'name'	=> 'demonicparadise',
			'user'	=> 'dbdemonicparadise',
			'pass'	=> 'yTd3D?4Lqs3W',
			'char'	=> 'utf8'
		...
		'template'	=>	'default',
		//Валюта в ЛК
		'cur'		=> 	array('RUB', 'пент', 'пентов', 'рубля', 'пент', 'р'),
		...
		'status'	=> array(
				...
				(
					...
					'name' 		=>	'VIP',
					//Описание статуса
					'desc'		=>	'Группа VIP покупается и дает больше возможностей, и привилегий по сравнению с обчной группой "Игроки"',
					//Наименование статуса в пермишенс
					'name_pex' 	=>	'vip',
					//Возможности группы
					'right'		=> 	array (
				...
				(
					...
					'name' 		=>	'Premium',
					//Описание статуса
					'desc'		=>	'Группа Premium покупается и дает больше возможностей, и привилегий по сравнению с обчной группой, и группой "VIP"',
					//Наименование статуса в пермишенс
					'name_pex' 	=>	'premium',
					//Возможности группы
					'right'		=> 	array (
				...
				(
					...
					'name' 		=>	'Haipan',
					//Описание статуса
					'desc'		=>	'Группа Haipan покупается и дает больше возможностей, и привилегий по сравнению с прошлыми группами',
					//Наименование статуса в пермишенс
					'name_pex' 	=>	'Haipan',
					//Возможности группы
					'right'		=> 	array (
